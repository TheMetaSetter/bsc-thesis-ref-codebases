...
def plot_time_series_comparison(
    raw_data1, raw_data2, label, title_name="Time Series Comparison", highlight_label=1
):
    ...
    num_figs = (
        B + num_batches_per_fig - 1
    ) // num_batches_per_fig  # Calculate number of figures needed
    ...
    for fig_idx in range(num_figs):
        ...
        plt.tight_layout(
            rect=[0, 0, 1, 0.95]
        )  # Adjust the layout to make space for the main title and legends
        plt.show()
